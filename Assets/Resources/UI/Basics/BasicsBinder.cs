...
namespace Basics
{
    public class BasicsBinder
    {
        public static void BindAll()
        {
            ...
            UIObjectFactory.SetPackageItemExtension(UI_ComboBoxPopup.URL, typeof(UI_ComboBoxPopup));
            ...
            UIObjectFactory.SetPackageItemExtension(UI_TitleLisItem.URL, typeof(UI_TitleLisItem));
